...
cvar_t	in_analog_disable  = {"in_analog_disable", "0", true};
cvar_t  in_analog_freelook = {"in_analog_freelook", "1", true};
...
//
	...
	Cvar_RegisterVariable (&in_analog_disable);
	Cvar_RegisterVariable (&in_analog_strafe);
	Cvar_RegisterVariable (&in_analog_freelook);
